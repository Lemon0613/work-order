  ...
  <div class="container">
    <div class="content">
      ...
      <el-form label-position="right" :rules="rules" :model="projectInfo" size="mini" label-width="120px">
        ...
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item label="其他收件人" required prop="receiver">
              <el-select v-model="projectInfo.receiver" multiple filterable placeholder="请选择" style="width: 100%">
                <el-option
                  v-for="item in member"
                  :key="item.id"
                  :label="item.u_name"
          ...
          <el-col :span="11">
            <el-form-item label="其他抄送人" required prop="copy">
              <el-select v-model="projectInfo.copy" multiple filterable placeholder="请选择" style="width: 100%">
                <el-option
                  v-for="item in member"
                  :key="item.id"
                  :label="item.u_name"
        ...
        <el-row>
          <el-form-item label="  ">
            <el-checkbox v-model="projectInfo.is_check">无需客户总监审核</el-checkbox>
          </el-form-item>
        </el-row>
        ...
        <el-row>
          ...
          <el-col :span="11" offset="1">
            <el-form-item label="广告任务" required prop="ad_work">
...
<script>
  ...
  // taskList: 工单包含的作业列表
  // task: 作业详情（新建用）
  // task.tonality: 创意调性 { img: 图片id无图为0, intro: 说明 }
  ...
  export default {
    ...
    methods: {
      ...
      handleSubmit() {
        ...
        projectObj.receiver = projectObj.receiver.join(',')
        projectObj.copy = projectObj.copy.join(',')
